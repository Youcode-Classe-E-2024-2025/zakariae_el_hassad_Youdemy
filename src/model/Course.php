...
class Course
{
    ...
    public function __construct(int $id = 0, string $name = "", string $description = "", ?string $image = null ,?string $file = null,  ?User $enseignant = null, ?Category $category = null, ?array $courseTags = null)
    {
        $this->id = $id;
        $this->name = $name;
