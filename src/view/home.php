  ...
  <div class="container mx-auto px-4">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <p class="text-gray-400 mb-6">Ipsum dolor sit amet, consectetur adipisicing elit. Itaque quis repellendus nesciunt quam cupiditate explicabo modi non error consequatur sunt molestiae laboriosam adipisci voluptatem possimus</p>
        <div class="flex space-x-4">
          <a href="#facebook" class="hover:text-blue-500"><i class="fa fa-facebook"></i></a>
          <a href="#twitter" class="hover:text-blue-400"><i class="fa fa-twitter"></i></a>
          <a href="#instagram" class="hover:text-pink-500"><i class="fa fa-instagram"></i></a>
          <a href="#google-plus" class="hover:text-red-500"><i class="fa fa-google-plus"></i></a>
          <a href="#linkedin" class="hover:text-blue-600"><i class="fa fa-linkedin"></i></a>
        </div>
      </div>

      <!-- Latest News -->
      <div>
        <h6 class="text-xl font-bold mb-4">Latest News</h6>
        <ul class="space-y-4">
          <li>
            <a href="#pages" class="text-gray-400 hover:text-white">Programming language</a>
            <h5><a href="#pages" class="text-sm text-gray-500">by Admin</a></h5>
          </li>
          <li>
            <a href="#pages" class="text-gray-400 hover:text-white">Graduate Admissions</a>
            <h5><a href="#pages" class="text-sm text-gray-500">by Admin</a></h5>
          </li>
          <li>
            <a href="#pages" class="text-gray-400 hover:text-white">Committed to educating</a>
            <h5><a href="#pages" class="text-sm text-gray-500">by Admin</a></h5>
          </li>
        </ul>
      </div>
      ...
      <!-- Contact Us -->
      <div>
        <h6 class="text-xl font-bold mb-4">Contact Us</h6>
        <ul class="space-y-4">
          <li class="flex items-center space-x-2">
            <i class="fa fa-map-marker text-gray-400"></i>
            <p class="text-gray-400">California, #32841 block, #221DRS 75 West Rock, Maple Building, UK.</p>
          </li>
          <li>
            <a href="tel:+7-800-999-800" class="flex items-center space-x-2 text-gray-400 hover:text-white">
              <i class="fa fa-phone"></i>
              <span>+(21)-255-999-8888</span>
            </a>
          </li>
          <li>
            <a href="mailto:estate-mail@support.com" class="flex items-center space-x-2 text-gray-400 hover:text-white">
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="#url" class="text-gray-400 hover:text-white">Forums</a></li>
          <li><a href="#url" class="text-gray-400 hover:text-white">Our Teachers</a></li>
          <li><a href="#url" class="text-gray-400 hover:text-white">Upcoming Events</a></li>
          <li><a href="#url" class="text-gray-400 hover:text-white">Popular Courses</a></li>
          <li><a href="#url" class="text-gray-400 hover:text-white">Verified Course</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="border-t border-gray-800 mt-12 pt-8">
      <div class="flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-400 text-center md:text-left">© 2020 Tutee. All rights reserved | Designed by <a href="//w3layouts.com" class="hover:text-white">W3layouts</a></p>
        <ul class="flex space-x-4 mt-4 md:mt-0">
          <li><a href="#link" class="text-gray-400 hover:text-white">Privacy policy</a></li>
          <li><a href="#link" class="text-gray-400 hover:text-white">Terms of service</a></li>
        </ul>
      </div>
    </div>
  </div>
